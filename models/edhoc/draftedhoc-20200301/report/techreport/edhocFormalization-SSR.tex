...
modeling, we assume all cryptographic primitives to be \emph{perfect}. The meaning
of \emph{perfect} is the usual one. 
For example, encrypted messages can only be decrypted with the key, and no hash collisions exist.
