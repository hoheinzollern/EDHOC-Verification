...
to~\cite{rfc8152,rfc7049}. \vnote{We need references here for both COSE and CBOR!}
...
%
From the session key material, a key exporter, named \mEdhoc{}-Exporter, based
on \mHkdf{} can be used to extract the encryption and integrity keys required
for \mOscore{}.
%
...
\knote{It was described above, bot explicitly named "EDHOC-Exporter". I fixed
that now}.
