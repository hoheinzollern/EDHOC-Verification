...
\mPskPsk.
%
The first authentication method in a method name denotes the
...
of the two half-keys \mGx{}, \mGy{} and the corresponding secret half-keys $x$
and $y$.
%
...
%
The seed for generating \mPRKtwo{} differs between methods.
%
