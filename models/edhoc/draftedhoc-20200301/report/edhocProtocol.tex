...
%
In addition to the exchange of DH half-keys and authentication information, the
...
%
As will be described below, when the authentication information is based on
...
%
In that case, the authentication information for that party is constructed
