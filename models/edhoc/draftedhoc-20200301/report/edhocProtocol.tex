...
Also, in \mOptls{}, 
%the ephemeral DH half-key and the challenge 
$e$ and $r$
...
%
\mNoise{} defines how to construct AKE protocols, using static long-term DH keys or pre-shared
keys as credentials.
%
Its goal is to use ``patterns'' to harmonize the many static long-term key DH-based AKE protocols, of which \mOptls{} is one.
%
...
%
However, \mEdhoc{} does not use the functions of \mNoise{} exactly as prescribed, and thus  cannot automatically inherit the properties enjoyed by XX.
