...
\knote{I think you may have cut too much. What is described here seems to be
    \mSigStat{}, not a general description of all the \mEdhoc{} (or even all the
    \mStat{}-based methods). Also, when you now have cut out the general
    description and the
    figure of it, the use of \mAuthi{} and \mAuthr{} makes no sense because
    they are defined in relation to that, not in relation to \mEdhoc{}.
    Proposal is to bring the commented out text above back. It is anyway shorter
    than this text, no?
}
%
