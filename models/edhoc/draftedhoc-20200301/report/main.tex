...
%
%Using the \mPsk{} method and the \mStat{} method allows a party to obtain
%non-repudiation, whereas the \mSig{} method does not.
%
%\knote{We don't formally prove this}
...
with a policy restricting the set of peers an they are allowed to run \mEdhoc{} with.
%
...
TBD. Just a paragraph if needed.
...
\iffalse % BEGIN COMMENT -- appendix
\appendix
%-------------------------------------------------------------------------- sec
\section*{Appendix}

\input{notesFromModelConstruct}
\fi % END COMMENT -- appendix
