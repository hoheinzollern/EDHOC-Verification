...
well-understood pre-shared key Diffie-Hellman and \mSigma{}, the newly added
...
twofold, and use mechanisms that have not previously been formally analyzed.
%
...
methods fulfill injective agreement on the session key material, and none
on the initiator's identity.
%
However, we did show that all methods fulfill an implicit agreement property on
...
\begin{table}[h!]
    \begin{center}
        \caption{Summary of verified properties. $S_P$ is the set of parameters:
