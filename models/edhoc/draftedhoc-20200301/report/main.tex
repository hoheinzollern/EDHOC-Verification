...
\knote{I agree. But that is as what EDHOC aims for. They haven't defined it
    better than that (if even that). There are trade-offs.
    Highest priority is small messages. We could simply remove "decent
    security". Would that be better?
}
\vnote{I think so, yes.}
...
cases as the combination of \mOscore{} and \mEdhoc.
%
