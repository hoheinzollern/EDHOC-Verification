...
\todo[inline, color=red, size=\footnotesize]{\textbf{\color{white}Please
        note: "authentication method" is what one party uses. The notation
        "\mSig{}-based method" and similar refers to a \emph{combined} method --
        not an authentication method used by a single party.
We do spell this out, but take care to use it consistently in the text.}}
