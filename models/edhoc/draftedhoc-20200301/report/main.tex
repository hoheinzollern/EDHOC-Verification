...
Some of the cores have been analyzed in the computational model
-- \mSigma{}~\cite{DBLP:conf/crypto/CanettiK02},
...
\vnote{I feel like we can remove this discussion about identity protection.
It can be handled, so the only problem is the message size.}
%
