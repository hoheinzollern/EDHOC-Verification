...
%
%Further, better understanding the intended use of \mEdhoc{} helps in defining a clearer security model.
%
...
passing through a door, whereas it may be undesirable for, say, a coffee machine to log a list of people and their coffee preferences. %whereas it may be undesirable for privacy purposes if it was even possible for a coffee vending machine to log such information.
%
...
\vnote{In response to our pointing this out? Say that explicitly if this is the case.}
%
...
%
\vedit{The}{Running the} \mPsk{} method or the \vedit{\mStat{}-based methods allow parties}{\mStat{} method allows a party} to obtain
non-repudiation, whereas \vedit{\mSig{}-based method do}{the \mSig{} method does} not.

\vedit{Do you mean a party that runs \mSig can get non-repudiation, no matter what the other party runs? My edits assume this. If this is not the case, fix accordingly.}
%
...
\vnote{Confusing sentence. A policy is not required to restrict the set of peers. What is the policy doing, and why does this restrict the set of peers?}
%
...
%
Assume someone has configured all devices in their home to be in the \vedit{restricted}{allowed}
set \vedit{}{of devices}, but that one of the devices $A$ has been compromised.
%
...
is part of the \vedit{restricted}{allowed} set, $B$ will complete and accept the \mEdhoc{} run
