...
\vnote{Please rewrite this, remove mentions of the later drafts, and focus on the difficulty of modelling this in Tamarin (if at all)}
...
it is not clear whether the listed security goals are important ones
...
as the \mStat{}-based authentication methods, is designed to be secure in the CK
...
%Vaishnavi: I'd like to keep it. I think it makes it very clear how we aren't too ``off the mark'' in terms of what we analyze. And I don't want to include this in 1.1 and muddy the waters, it's good to have a semantic separation of introducing the reader to what we have done, and point to this at the very end. I'd much rather that in 1.1 you added stuff about why the Tamarin modelling was not straightforward.
...
%(along with the \mPskPsk{} mode as presented in~\textbf{*** Enter proper reference here ***}). 
...
The authors have removed the \mPskPsk{} mode as of the IETF draft dated August 2020. In the December 2020 draft, they discuss how to modify the encryption function in message  \mMsgtwo{} and add a ``real'' encryption function, as opposed to the current use of XOR for encryption. 
