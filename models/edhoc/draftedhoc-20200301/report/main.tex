...
%\keywords{Formal verification \and Security \and IETF standardization \and Key establishment protocols \and Tamarin}
...
in May 2018.
%
In the current version, the \mPskPsk{} method has been removed.~\footnote{In our analysis in~\cite{edhocTamarinRepo}, we also analyze the last known variant of the \mPskPsk{} method, from~{\textbf{*** Put in the right link to the spec version here ***}}, since it might be added again. We present a quick overview of the same in the appendix.}
...
\knote{More standard impact: -02 draft: 4th message to get key confirmation
...
%
Mutual injective agreement covers the parameters: responder identity, roles,
session key material (except for \mGiy{} when initiator uses a \mStat{}-based
...
\begin{table}[h!]
    \begin{center}
        \caption{Summary of verified properties. A $*$ marks restrictions as
            mentioned above.}
        \label{tab:props}
        \begin{tabular}{|l|c|c|c|c|c|}
                ...
                \hline
                Injective agreement for I & \cm & \cm & \cm & $\cm^*$ & $\cm^*$\\
                Injective agreement for R & \cm & \cm & \cm & \cm & \cm\\
                Implicit agreement for I & \cm & \cm & \cm & \cm & \cm\\
                Implicit agreement for R & \cm & \cm & \cm & \cm & \cm\\
