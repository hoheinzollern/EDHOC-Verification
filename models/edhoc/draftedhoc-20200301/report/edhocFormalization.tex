...
\paragraph{Key-compromise impersonation} (KCI) This property takes the perspective of one
...
\knote{TODO: make link point to the final code when it is in its final place.}
