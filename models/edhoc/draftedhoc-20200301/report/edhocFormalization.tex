...
not present in the original document, which will appear in camelCase, and the
syntax for Diffie-Hellman exponentiation which is specific to \mTamarin{}.
...
to know the message \lstinline{aeadEncrypt(k, m, ad, al)}.
