...
Given that the secrecy and agreement properties %, and parameter set $S_P$ defined
above hold, other properties can be inferred to hold in our threat model as well.
%
