...
\newcommand{\mKtwo}{\mConstStyle{K\_2}\xspace}
\newcommand{\mTHthree}{\mConstStyle{TH\_3}\xspace}
\newcommand{\mKthree}{\mConstStyle{K\_3}\xspace}
...
\newcommand{\msg}[4]{\draw[->] ([yshift=-#1]#2.south) coordinate (l1)--(l1-|#3) node[midway, above]{#4}}
\newcommand{\action}[3]{\node[draw,align=center,below={#1} of {#2}]{#3}}
...
\newcommand{\mDecrypt}{\mathtit{decrypt}}