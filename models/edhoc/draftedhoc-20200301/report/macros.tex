...
\newcommand{\mRevLTK}[1]{\ensuremath{\mathbf{A}_\mFunStyle{LTK}(#1)}}
\newcommand{\mTEE}[1]{\ensuremath{\mathbf{A}_\mFunStyle{TEE}(#1)}}
\newcommand{\mRevEph}[1]{\ensuremath{\mathbf{A}_\mFunStyle{Eph}(#1)}}
...
% Tamarin symbols
\newcommand{\ifarrow}[1][]{\ifthenelse{\equal{#1}{}}{\rightarrow}{-\hspace{-4.2pt}[{#1}]\hspace{-5pt}\rightarrow}}
