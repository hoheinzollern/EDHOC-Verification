...
%
In this paper, we formally analyze all methods of \mEdhoc{} in an enhanced
symbolic Dolev-Yao model using the \mTamarin{} tool.
%
...
%
In the course of our analysis, we also identified other improvements to the
design and specification of \mEdhoc, which we have communicated to
the designers, and which they have incorporated in newer versions of the
standard.
}
%
